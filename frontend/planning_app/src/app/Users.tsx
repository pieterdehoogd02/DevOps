        ...
        return (
            <div className="w-full h-auto bg-black bg-opacity-30 flex flex-col gap-3 rounded-xl">
                ...
                <div className="flex flex-col w-full">
                    ...
                    <div className="grid grid-cols-[repeat(auto-fit,minmax(20px,1fr))] gap-x-[8px] gap-y-[10px] text-sm font-medium text-gray-500 overflow-x-auto ml-[5px]">
                        {
                ...
                <div className="flex w-full flex-col">
                    ...
                    <div className="grid grid-cols-[repeat(auto-fit,minmax(20px,1fr))] gap-x-[8px] gap-y-[10px] text-gray-500 w-full overflow-x-auto ml-[5px]">
                        {
