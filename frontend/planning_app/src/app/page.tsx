  ...
  return (
    <div className="relative top-[2%] left-[2%] h-[6%] w-[96%] bg-[#312C2C] bg-opacity-70 rounded-xl flex flex-row">
        <div className="relative left-[20%] w-[40%] top-0 h-full flex flex-row items-center justify-center">
          <div className="flex flex-row w-[35%] h-full font-sans font-semibold text-white justify-start items-center">My projects</div>
          <div className="flex flex-row w-[35%]  h-full font-sans font-semibold text-white justify-start items-center">People</div>
          <div className="flex flex-row w-[30%] h-full font-sans font-semibold text-white justify-start items-center">
            <div className="h-[70%] rounded-md bg-blue-600 w-[50%] flex flex-row justify-center items-center">Create</div>
          </div>
        </div>
    ...
    <div className="relative left-[2%] top-[4%] w-[16%] h-[95%] bg-[#312C2C] bg-opacity-70 rounded-xl flex flex-col">
      <div className="relative top-[10%] left-0 flex flex-row w-full h-[10%]">
        ...
        <div className="left-0 top-0 w-[80%] h-full flex flex-col justify-end">
          <div className="indent-[15px] w-[80%] h-[55%] text-lg text-white flex items-end">
            Project name
          </div>
          <div className="indent-[15px] w-[80%] h-[45%] text-xs text-white flex items-start">
            Software Engineering
          </div>
        </div>
      </div>
      <div className="relative top-[10%] left-0 flex flex-row w-full h-[10%] justify-center items-center text-lg text-white">
        Backlog
      </div>
      <div className="relative top-[10%] left-0 flex flex-row w-full h-[10%] justify-center items-center text-lg text-white">
        Roles
